var _e=n=>{throw TypeError(n)};var Le=(n,e,t)=>e.has(n)||_e("Cannot "+t);var r=(n,e,t)=>(Le(n,e,"read from private field"),t?t.call(n):e.get(n)),a=(n,e,t)=>e.has(n)?_e("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(n):e.set(n,t),c=(n,e,t,s)=>(Le(n,e,"write to private field"),s?s.call(n,t):e.set(n,t),t),w=(n,e,t)=>(Le(n,e,"access private method"),t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function t(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(i){if(i.ep)return;i.ep=!0;const o=t(i);fetch(i.href,o)}})();var D,m,Q;class dt{constructor({view:e,model:t,dbModel:s}){a(this,D);a(this,m);a(this,Q);c(this,D,t),c(this,m,e),c(this,Q,s)}async showStoryList(){r(this,m).showLoading();try{let e=await r(this,Q).getAll();e.length>0&&r(this,m).populateStoryList(e);const t=await r(this,D).getData();if(!t.ok){console.log(`Error : ${t}`);return}t.listStory,r(this,m).populateStoryList(t.listStory)}catch(e){console.log(`Error : ${e}`)}finally{r(this,m).hideLoading()}}async showMapMarker(){r(this,m).showMapLoading();try{const e=await r(this,D).getData();if(!e.ok){console.log(`Error : ${e}`);return}await r(this,m).populateMapMarker(0,0,e.listStory),await r(this,m).populateMapMarker(e.listStory.lat,e.listStory.lon,e.listStory)}catch(e){console.log(`Error : ${e}`)}finally{r(this,m).hideMapLoading()}}}D=new WeakMap,m=new WeakMap,Q=new WeakMap;const I="https://story-api.dicoding.dev/v1",Re="123",ut="BCCs2eonMI-6H2ctvFaWg-UYdDv387Vno_bzUzALpB442r2lCnsHmtrx8biyPi_E-1fSGABK_Qs_GlvPoJJqxbk",gt={mapTiller:"lnuhAxbXLgkhiXPIgsjO"};function Oe(n){const e=n.split("/");return{resource:e[1]||null,id:e[2]||null}}function pt(n){let e="";return n.resource&&(e=e.concat(`/${n.resource}`)),n.id&&(e=e.concat("/:id")),e||"/"}function Ge(){return location.hash.replace("#","")||"/"}function ze(){const n=Ge(),e=Oe(n);return pt(e)}function Ue(){const n=Ge();return Oe(n)}function C(){try{const n=localStorage.getItem(Re);return n==="null"||n==="undefined"?null:n}catch(n){return console.error("getAccessToken: error:",n),null}}function mt(n){try{return localStorage.setItem(Re,n),!0}catch(e){return console.error("putAccessToken: error:",e),!1}}function Ne(){try{return localStorage.removeItem(Re),!0}catch(n){return console.error("getLogout: error:",n),!1}}const ht=["/login","/register"];function ke(n){const e=ze(),t=!!C();return ht.includes(e)&&t?(location.hash="/",null):n}function T(n){return!C()?(location.hash="/login",null):n}function Fe(){Ne()}const yt=Object.freeze(Object.defineProperty({__proto__:null,checkAuthenticatedRoute:T,checkUnauthenticatedRouteOnly:ke,getAccessToken:C,getLogout:Fe,putAccessToken:mt,removeAccessToken:Ne},Symbol.toStringTag,{value:"Module"})),M={OPEN_STREET_MAP:(n,e)=>`https://nominatim.openstreetmap.org/reverse?lat=${n}&lon=${e}&format=json`,OPEN_STREET_MAP_ADDRESS_TO_LATLNG:n=>`https://nominatim.openstreetmap.org/search?format=json&q=${n}`,REGISTER:`${I}/register`,LOGIN:`${I}/login`,GET_ALL_STORY:`${I}/stories`,ADD_STORY:`${I}/stories`,GET_DETAIL_STORY:`${I}/stories/`,SUBSCRIBE:`${I}/notifications/subscribe`,UNSUBSCRIBE:`${I}/notifications/subscribe`};async function wt(n){const t=await(await fetch(M.OPEN_STREET_MAP_ADDRESS_TO_LATLNG(n))).json(),{lat:s,lon:i}=t[0];return{lat:s,lng:i}}async function pe({lat:n,lng:e}){const t=await fetch(M.OPEN_STREET_MAP(n,e)),s=await t.json();return s.display_name?{address:s.display_name,ok:t.ok}:{address:"Address is not found",ok:t.ok}}async function ft({name:n,email:e,password:t}){const s=JSON.stringify({name:n,email:e,password:t}),i=await fetch(M.REGISTER,{method:"POST",headers:{"Content-type":"application/json"},body:s});return{...await i.json(),ok:i.ok}}async function vt({email:n,password:e}){const t=JSON.stringify({email:n,password:e}),s=await fetch(M.LOGIN,{method:"POST",headers:{"Content-Type":"application/json"},body:t});return{...await s.json(),ok:s.ok}}async function bt(){const n=C(),e=await fetch(M.GET_ALL_STORY,{headers:{Authorization:`Bearer ${n}`}});return{...await e.json(),ok:e.ok}}async function Ze(n){const e=C(),t=await fetch(`${M.GET_DETAIL_STORY}${n}`,{headers:{Authorization:`Bearer ${e}`}});return{...await t.json(),ok:t.ok}}async function Lt(n){const e=C(),t=await fetch(M.ADD_STORY,{method:"POST",headers:{Authorization:`Bearer ${e}`},body:n});return{...await t.json(),ok:t.ok}}async function qe({endpoint:n,keys:{p256dh:e,auth:t}}){const s=C(),i=JSON.stringify({endpoint:n,keys:{p256dh:e,auth:t}}),o=await fetch(M.SUBSCRIBE,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${s}`},body:i});return{...await o.json(),ok:o.ok}}async function We({endpoint:n}){const e=C(),t=JSON.stringify({endpoint:n}),s=await fetch(M.UNSUBSCRIBE,{method:"DELETE",headers:{"Content-Type":"application/json",Authorization:`Bearer ${e}`},body:t});return{...await s.json(),ok:s.ok}}const Y=Object.freeze(Object.defineProperty({__proto__:null,getAddress:pe,getData:bt,getLatLng:wt,getLogin:vt,getRegistered:ft,getSingle:Ze,postStory:Lt,subscribePushNotification:qe,unsubscribePushNotification:We},Symbol.toStringTag,{value:"Module"}));function we(n,e="en-US",t={}){return new Date(n).toLocaleDateString(e,{year:"numeric",month:"long",day:"numeric",...t})}function xt(){window.stream&&(window.stream.getTracks().forEach(n=>n.stop()),window.stream=null)}async function St(n){const e=n.src;return await(await fetch(e)).blob()}function kt(n){const e="=".repeat((4-n.length%4)%4),t=(n+e).replace(/-/g,"+").replace(/_/g,"/"),s=atob(t),i=new Uint8Array(s.length);for(let o=0;o<s.length;o++)i[o]=s.charCodeAt(o);return i}function X(){return`
  <div class="min-h-screen flex items-center justify-center">
    ...
    `}function Ct({id:n,name:e,description:t,photoUrl:s,createdAt:i,order:o}){return`
    ...
    `}function Mt({id:n,name:e,description:t,image:s,createdAt:i,order:o}){const l=URL.createObjectURL(s);return`
  ...
  <svg viewBox="0 -0.5 21 21" width="16" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>delete [#1487]</title> <desc>Created with Sketch.</desc> <defs> </defs> <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"> <g id="Dribbble-Light-Preview" transform="translate(-179.000000, -360.000000)" fill="#d7d1d1"> <g id="icons" transform="translate(56.000000, 160.000000)"> <path d="M130.35,216 L132.45,216 L132.45,208 L130.35,208 L130.35,216 Z M134.55,216 L136.65,216 L136.65,208 L134.55,208 L134.55,216 Z M128.25,218 L138.75,218 L138.75,206 L128.25,206 L128.25,218 Z M130.35,204 L136.65,204 L136.65,202 L130.35,202 L130.35,204 Z M138.75,204 L138.75,200 L128.25,200 L128.25,204 L123,204 L123,206 L126.15,206 L126.15,220 L140.85,220 L140.85,206 L144,206 L144,204 L138.75,204 Z" id="delete-[#1487]"> </path> </g> </g> </g> </g></svg>  </div>
    `}function Et({id:n,name:e,photoUrl:t,description:s,createdAt:i,address:o}){return`
  ...
  `}function Bt({id:n,name:e,image:t,description:s,createdAt:i,address:o}){return`
  ...
  `}var u,g,$e;let fe=($e=class{constructor({containerId:e,lat:t,lng:s,draggable:i=!1}){a(this,u,null);a(this,g,null);this.init(e,t,s,i)}init(e,t,s,i){c(this,u,L.map(e).setView([t,s],5)),this.setLayer()}initEvent(){r(this,u).on("click",e=>this.handleMapClick(e)),r(this,g).on("dragend",()=>this.handleMapDrag())}async costumMark({lat:e,lng:t,option:s={}},i=null){i.forEach(o=>{o.lat===null||o.lon===null||c(this,g,L.marker([o.lat,o.lon],s).addTo(r(this,u)).bindPopup(` 
                ...
                <div class=" flex flex-col">
                    ...
                    <h3 class="font-semibold mb-1 mt-2">${s.name}</h3>
                    <span class="max-w-[150px] line-clamp-3">${s.description}</span>
                </div>`))}async mark({lat:e,lng:t,option:s}){try{let o=(await pe({lat:e,lng:t})).address||"Address is not found";c(this,g,L.marker([e,t],s).addTo(r(this,u)).bindPopup(`<b>Alamat: </b> ${o}`))}catch(i){console.error("Error mengambil alamat:",i)}}setLayer(){const e=L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:"© OpenStreetMap contributors"}),t=L.tileLayer("https://mt1.google.com/vt/lyrs=s&x={x}&y={y}&z={z}",{attribution:"© Google Maps"}),s=L.tileLayer(`https://api.maptiler.com/maps/streets/{z}/{x}/{y}.png?key=${gt.mapTiller}`,{attribution:"© MapTiler"});e.addTo(r(this,u));const i={OpenStreetMap:e,"Google Satellite":t,"MapTiler Streets":s};L.control.layers(i).addTo(r(this,u))}async handleMapClick(e){const{lat:t,lng:s}=e.latlng;try{let o=(await pe({lat:t,lng:s})).address||"Address is not found";this.updateMarker(t,s,o)}catch(i){console.error("Error mengambil alamat:",i)}this.updateLatLngFields(t,s)}async handleMapDrag(){const{lat:e,lng:t}=r(this,g)._latlng;try{let i=(await pe({lat:e,lng:t})).address||"Address is not found";this.updateMarker(e,t,i)}catch(s){console.error("Error mengambil alamat:",s)}this.updateLatLngFields(e,t)}updateMarker(e,t,s){r(this,g)&&r(this,u).removeLayer(r(this,g)),c(this,g,L.marker([e,t],{draggable:!0}).addTo(r(this,u)).bindPopup(`<b>Alamat:</b> ${s}`).openPopup()),r(this,g).on("dragend",()=>this.handleMapDrag())}updateLatLngFields(e,t){document.getElementById("location-lat").value=e,document.getElementById("location-lng").value=t}},u=new WeakMap,g=new WeakMap,$e);const Ce=(n,e)=>e.some(t=>n instanceof t);let Ve,je;function It(){return Ve||(Ve=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Tt(){return je||(je=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Me=new WeakMap,xe=new WeakMap,ve=new WeakMap;function Rt(n){const e=new Promise((t,s)=>{const i=()=>{n.removeEventListener("success",o),n.removeEventListener("error",l)},o=()=>{t(P(n.result)),i()},l=()=>{s(n.error),i()};n.addEventListener("success",o),n.addEventListener("error",l)});return ve.set(e,n),e}function _t(n){if(Me.has(n))return;const e=new Promise((t,s)=>{const i=()=>{n.removeEventListener("complete",o),n.removeEventListener("error",l),n.removeEventListener("abort",l)},o=()=>{t(),i()},l=()=>{s(n.error||new DOMException("AbortError","AbortError")),i()};n.addEventListener("complete",o),n.addEventListener("error",l),n.addEventListener("abort",l)});Me.set(n,e)}let Ee={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return Me.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return P(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function Xe(n){Ee=n(Ee)}function Vt(n){return Tt().includes(n)?function(...e){return n.apply(Be(this),e),P(this.request)}:function(...e){return P(n.apply(Be(this),e))}}function jt(n){return typeof n=="function"?Vt(n):(n instanceof IDBTransaction&&_t(n),Ce(n,It())?new Proxy(n,Ee):n)}function P(n){if(n instanceof IDBRequest)return Rt(n);if(xe.has(n))return xe.get(n);const e=jt(n);return e!==n&&(xe.set(n,e),ve.set(e,n)),e}const Be=n=>ve.get(n);function Pt(n,e,{blocked:t,upgrade:s,blocking:i,terminated:o}={}){const l=indexedDB.open(n,e),A=P(l);return s&&l.addEventListener("upgradeneeded",d=>{s(P(l.result),d.oldVersion,d.newVersion,P(l.transaction),d)}),t&&l.addEventListener("blocked",d=>t(d.oldVersion,d.newVersion,d)),A.then(d=>{o&&d.addEventListener("close",()=>o()),i&&d.addEventListener("versionchange",B=>i(B.oldVersion,B.newVersion,B))}).catch(()=>{}),A}const At=["get","getKey","getAll","getAllKeys","count"],Dt=["put","add","delete","clear"],Se=new Map;function Pe(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(Se.get(e))return Se.get(e);const t=e.replace(/FromIndex$/,""),s=e!==t,i=Dt.includes(t);if(!(t in(s?IDBIndex:IDBObjectStore).prototype)||!(i||At.includes(t)))return;const o=async function(l,...A){const d=this.transaction(l,i?"readwrite":"readonly");let B=d.store;return s&&(B=B.index(A.shift())),(await Promise.all([B[t](...A),i&&d.done]))[0]};return Se.set(e,o),o}Xe(n=>({...n,get:(e,t,s)=>Pe(e,t)||n.get(e,t,s),has:(e,t)=>!!Pe(e,t)||n.has(e,t)}));const Ht=["continue","continuePrimaryKey","advance"],Ae={},Ie=new WeakMap,Qe=new WeakMap,$t={get(n,e){if(!Ht.includes(e))return n[e];let t=Ae[e];return t||(t=Ae[e]=function(...s){Ie.set(this,Qe.get(this)[e](...s))}),t}};async function*Ot(...n){let e=this;if(e instanceof IDBCursor||(e=await e.openCursor(...n)),!e)return;e=e;const t=new Proxy(e,$t);for(Qe.set(t,e),ve.set(t,Be(e));e;)yield t,e=await(Ie.get(t)||e.continue()),Ie.delete(t)}function De(n,e){return e===Symbol.asyncIterator&&Ce(n,[IDBIndex,IDBObjectStore,IDBCursor])||e==="iterate"&&Ce(n,[IDBIndex,IDBObjectStore])}Xe(n=>({...n,get(e,t,s){return De(e,t)?Ot:n.get(e,t,s)},has(e,t){return De(e,t)||n.has(e,t)}}));const Gt="app",zt=1,f="saved-stories",J=Pt(Gt,zt,{upgrade:n=>{n.objectStoreNames.contains(f)||n.createObjectStore(f,{keyPath:"id"})}}),be={async putAndRefresh(n){const t=(await J).transaction(f,"readwrite"),s=t.objectStore(f);await s.clear(),await Promise.all(n.map(i=>{s.put(i)})),await t.done},async getAll(){return(await J).getAll(f)},async getById(n){return(await J).get(f,n)},async add(n){const t=(await J).transaction(f,"readwrite");t.objectStore(f).put(n),await t.done},async delete(n){const t=(await J).transaction(f,"readwrite");t.objectStore(f).delete(n),await t.done}};var H,ee,me,et;class Ut{constructor(){a(this,me);a(this,H,null);a(this,ee,null)}async render(){return`
    <div class="stabilize-top pb-10">
      <section class="mb-5 ">
    ...
    `}async afterRender(){c(this,H,new dt({view:this,model:Y,dbModel:be})),await r(this,H).showStoryList(),await w(this,me,et).call(this),await r(this,H).showMapMarker()}async populateMapMarker(e,t,s){await r(this,ee).costumMark({lat:e,lng:t},s)}populateStoryList(e){if(e.length<=0){this.storyListEmpty();return}let t=0;const s=e.reduce((i,o)=>(t=t+1,i.concat(Ct({...o,order:t}))),"");document.getElementById("story-list-container").innerHTML=s}storyListEmpty(){document.getElementById("responsive").innerHTML=Ke()}showLoading(){document.getElementById("story-loading-container").innerHTML=X()}hideLoading(){document.getElementById("story-loading-container").innerHTML=""}showMapLoading(){document.getElementById("story-loading-container").innerHTML=X()}hideMapLoading(){document.getElementById("story-loading-container").innerHTML=""}}H=new WeakMap,ee=new WeakMap,me=new WeakSet,et=async function(){c(this,ee,new fe({containerId:document.getElementById("map-container"),lat:-.5341981739396645,lng:117.12302541745886}))};var b,te;class Nt{constructor({view:e,model:t}){a(this,b);a(this,te);c(this,b,e),c(this,te,t)}async getRegistered({name:e,email:t,password:s}){r(this,b).showSubmitLoadingButton();try{const i=await r(this,te).getRegistered({name:e,email:t,password:s});if(!i.ok){console.error("getRegistered: response:",i),r(this,b).registeredFailed(i.message);return}r(this,b).registeredSuccessfully(i.message,i.data)}catch(i){console.error("getRegistered: error:",i),r(this,b).registeredFailed(i.message)}finally{r(this,b).hideSubmitLoadingButton()}}}b=new WeakMap,te=new WeakMap;var ne,he,tt;class Ft{constructor(){a(this,he);a(this,ne,null)}async render(){return`
      <section class="flex justify-center items-center min-h-screen">

        <div class="lg:bg-zinc-900 lg:rounded-2xl px-10 py-8" style="max-width: 500px; width: 100%;">
          
          <img src="/dicoding/images/logo.png" width="75px">
    ...
    `}async afterRender(){c(this,ne,new Nt({view:this,model:Y})),w(this,he,tt).call(this)}registeredSuccessfully(e){console.log(e),location.hash="/login"}registeredFailed(e){alert(e)}showSubmitLoadingButton(){document.getElementById("submit-button-container").innerHTML=`
    ...
    `}hideSubmitLoadingButton(){document.getElementById("submit-button-container").innerHTML=`
      <button class="primary-btn w-full" type="submit">Daftar akun</button>
    `}}ne=new WeakMap,he=new WeakSet,tt=function(){document.getElementById("register-form").addEventListener("submit",async e=>{e.preventDefault();const t={name:document.getElementById("name-input").value,email:document.getElementById("email-input").value,password:document.getElementById("password-input").value};await r(this,ne).getRegistered(t)})};var x,se,re;class Zt{constructor({view:e,model:t,authModel:s}){a(this,x);a(this,se);a(this,re);c(this,x,e),c(this,se,t),c(this,re,s)}async getLogin({email:e,password:t}){r(this,x).showSubmitLoadingButton();try{const s=await r(this,se).getLogin({email:e,password:t});if(!s.ok){console.log("getLogin: response:",s),r(this,x).loginFailed(s.message);return}console.log("getLogin: response:",s),r(this,re).putAccessToken(s.loginResult.token),r(this,x).loginSuccessfully(s.message,s.data)}catch(s){console.error("getLogin: error:",s),r(this,x).loginFailed(s.message)}finally{r(this,x).hideSubmitLoadingButton()}}}x=new WeakMap,se=new WeakMap,re=new WeakMap;var ie,ye,nt;class qt{constructor(){a(this,ye);a(this,ie,null)}render(){return`
    ...
    `}async afterRender(){c(this,ie,new Zt({view:this,model:Y,authModel:yt})),w(this,ye,nt).call(this)}loginSuccessfully(e){console.log(e),location.hash="/"}loginFailed(e){alert(e)}showSubmitLoadingButton(){document.getElementById("submit-button-container").innerHTML=`
      <button class="primary-btn w-full cursor-not-allowed">
        <svg class="mx-auto size-6 animate-spin text-blue-500" xmlns="http://www.w3.org/2000/svg" 
          fill="none" viewBox="0 0 24 24"><circle class="opacity-[10%]" cx="12" cy="12" r="10" stroke="currentColor" 
          stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z">
    ...
    `}hideSubmitLoadingButton(){document.getElementById("submit-button-container").innerHTML=`
      <button id="login-button" class="primary-btn w-full" type="submit">Login</button>
    `}}ie=new WeakMap,ye=new WeakSet,nt=function(){document.getElementById("login-form").addEventListener("submit",async e=>{e.preventDefault();const t={email:document.getElementById("email-input").value,password:document.getElementById("password-input").value};await r(this,ie).getLogin(t)})};var h,$,O,E,R;class Wt{constructor({video:e,videoContainer:t,openButton:s,canvas:i,imagePreview:o}){a(this,h,null);a(this,$,null);a(this,O,null);a(this,E,null);a(this,R,null);c(this,h,e),c(this,O,s),c(this,$,t),c(this,E,i),c(this,R,o)}async toggle(){if(window.stream)window.stream.getTracks().forEach(e=>e.stop()),r(this,h).srcObject=null,r(this,$).style.display="none",r(this,O).textContent="Open Camera",window.stream=null;else try{window.stream=await navigator.mediaDevices.getUserMedia({video:!0}),r(this,h).srcObject=window.stream,r(this,$).style.display="block",r(this,O).textContent="Close Camera"}catch(e){console.log(`Camera : ${e.message}`)}}async take(){const e=r(this,E).getContext("2d");return r(this,E).width=r(this,h).videoWidth,r(this,E).height=r(this,h).videoHeight,e.drawImage(r(this,h),0,0,r(this,h).videoWidth,r(this,h).videoHeight),new Promise(t=>{r(this,E).toBlob(s=>{if(s){r(this,R).src=URL.createObjectURL(s),r(this,R).alt="image-preview",r(this,R).style.display="block";const i=new File([s],"image.jpg",{type:"image/png"});t(i)}else t(null)},"image/png")})}}h=new WeakMap,$=new WeakMap,O=new WeakMap,E=new WeakMap,R=new WeakMap;var oe,S;class Kt{constructor({view:e,model:t}){a(this,oe);a(this,S);c(this,oe,t),c(this,S,e)}async createStory(e){r(this,S).showSubmitLoadingButton();try{const t=await r(this,oe).postStory(e);if(!t.ok){r(this,S).createFailed(t.message);return}r(this,S).createdSuccessfully(t.message)}catch(t){r(this,S).createFailed(t),console.log(t)}finally{r(this,S).hideSubmitLoadingButton()}}}oe=new WeakMap,S=new WeakMap;var ae,G,z,_,v,st,rt,it,ot;class Yt{constructor(){a(this,v);a(this,ae,null);a(this,G,null);a(this,z,null);a(this,_,null)}async render(){return`
        ...
        `}async afterRender(){c(this,ae,new Kt({view:this,model:Y})),await w(this,v,st).call(this),await w(this,v,rt).call(this),await w(this,v,it).call(this),w(this,v,ot).call(this)}createdSuccessfully(e){alert(e),location.hash="/"}createFailed(e){alert(e)}showSubmitLoadingButton(){document.getElementById("submit-button-container").innerHTML=`
        <button class="primary-btn w-full cursor-not-allowed">
            <svg class="mx-auto size-6 animate-spin text-blue-500" xmlns="http://www.w3.org/2000/svg" 
            fill="none" viewBox="0 0 24 24"><circle class="opacity-[10%]" cx="12" cy="12" r="10" stroke="currentColor" 
            stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z">
        ...
        </div>`}populateStoryList(e){if(e.length<=0){this.savedStoryListEmpty();return}let t=0;const s=e.reduce((i,o)=>(t=t+1,i.concat(Mt({...o,order:t}))),"");document.getElementById("story-saved-container").innerHTML=s,this.setupUnsaveButtons()}savedStoryListEmpty(){document.getElementById("container").innerHTML=Ke()}showLoading(){document.getElementById("container").innerHTML=X()}hideLoading(){document.getElementById("container").innerHTML=""}}j=new WeakMap;var ue,p,F;class nn{constructor({view:e,model:t,dbModel:s}){a(this,ue);a(this,p);a(this,F);c(this,ue,t),c(this,p,e),c(this,F,s)}async showDetailSavedStory(){r(this,p).showLoading();try{const e=await r(this,F).getById(Ue().id);if(!e){r(this,p).dataIsNotFound();return}if(e.address==="Unknown (Missing coordinat)")r(this,p).setItem(e),r(this,p).setupUnsaveButton(),r(this,p).setupMap(-.5341981739396645,117.12302541745886);else{const t=await r(this,ue).getLatLng(e.address);r(this,p).setItem(e),r(this,p).setupMap(t.lat,t.lng),r(this,p).createMark(t.lat,t.lng,e),r(this,p).setupUnsaveButton()}}catch(e){console.error(e)}}async unsaveSavedStory(e){try{await r(this,F).delete(e),alert("Data successfully unsaved !"),location.hash="/saved"}catch(t){alert("Failed to unsave data"),console.error(t)}}}ue=new WeakMap,p=new WeakMap,F=new WeakMap;var ge,Z;class sn{constructor(){a(this,ge);a(this,Z)}async render(){return`
        <section id="saved-story-detail" class="responsive"></section>
        `}async afterRender(){c(this,Z,new nn({view:this,model:Y,dbModel:be})),await r(this,Z).showDetailSavedStory()}setupUnsaveButton(){document.getElementById("unsave-btn").addEventListener("click",async e=>{const t=e.target.closest("#unsave-btn").dataset.id;await r(this,Z).unsaveSavedStory(t)})}async setupMap(e,t){c(this,ge,new fe({containerId:document.getElementById("map-container"),lat:e,lng:t}))}async createMark(e,t,s){r(this,ge).createSavedMark(e,t,s)}async setItem(e){document.getElementById("saved-story-detail").innerHTML=Bt(e)}showLoading(){document.getElementById("saved-story-detail").innerHTML=X()}hideLoading(){document.getElementById("saved-story-detail").innerHTML=""}dataIsNotFound(){document.getElementById("saved-story-detail").innerHTML='<h1 class="flex justify-center items-center min-h-screen text-xl">No data found</h1>'}}ge=new WeakMap,Z=new WeakMap;const He={"/login":()=>ke(new qt),"/register":()=>ke(new Ft),"/":()=>T(new Ut),"/detailStory/:id":()=>T(new Qt),"/createStory":()=>T(new Yt),"/saved":()=>T(new tn),"/saved/:id":()=>T(new sn),"/404":()=>T(new Jt)};function rn(){return{userVisibleOnly:!0,applicationServerKey:kt(ut)}}async function on(){if(!("Notification"in window))return console.error("Notification API unsupported."),!1;const n=await Notification.requestPermission();if(n==="denied")return alert("Izin notifikasi ditolak."),!1;if(n==="default")return alert("Izin notifikasi ditutup atau diabaikan."),!1}async function an(){return await(await navigator.serviceWorker.getRegistration()).pushManager.getSubscription()}async function cn(){await on();let n;try{n=await(await navigator.serviceWorker.getRegistration()).pushManager.subscribe(rn());const{endpoint:t,keys:s}=n.toJSON(),i=await qe({endpoint:t,keys:s});if(!i.ok){console.log("subscribe: response:",i),alert(i.message);return}alert(i.message),document.getElementById("subscribe-button-container").innerHTML=Je()}catch(e){console.error(e)}}async function ln(){let n;try{n=await an();const{endpoint:e}=n.toJSON(),t=await n.unsubscribe(),s=await We({endpoint:e});if(!s.ok){console.log("subscribe: response:",s),alert(s.message);return}alert(s.message),document.getElementById("subscribe-button-container").innerHTML=Ye()}catch(e){console.error(e)}}async function at(){return!!await(await navigator.serviceWorker.getRegistration()).pushManager.getSubscription()}async function dn(){await at()?await ln():await cn()}var q,W,k,K,ct,lt;class un{constructor({navigationDrawer:e,drawerButton:t,content:s}){a(this,K);a(this,q,null);a(this,W,null);a(this,k,null);c(this,q,s),c(this,W,t),c(this,k,e),w(this,K,ct).call(this),w(this,K,lt).call(this)}async renderPage(){!!C()?document.querySelector("header").style.display="block":document.querySelector("header").style.display="none";const t=ze();let s=He[t];s===void 0&&(s=He["/404"]);const i=s();if(!document.startViewTransition){r(this,q).innerHTML=await i.render(),await i.afterRender();return}document.startViewTransition(async()=>{r(this,q).innerHTML=await i.render(),await i.afterRender()}).updateCallbackDone.then(()=>{scrollTo({top:0,behavior:"instant"})})}}q=new WeakMap,W=new WeakMap,k=new WeakMap,K=new WeakSet,ct=function(){r(this,W).addEventListener("click",()=>{r(this,k).classList.toggle("open")}),document.body.addEventListener("click",t=>{!r(this,k).contains(t.target)&&!r(this,W).contains(t.target)&&r(this,k).classList.remove("open"),r(this,k).querySelectorAll("a").forEach(s=>{s.contains(t.target)&&r(this,k).classList.remove("open")})}),document.getElementById("logout-button").addEventListener("click",t=>{t.preventDefault(),confirm("Are you sure you want to logout?")&&(Fe(),location.hash="/login")})},lt=async function(){const e=document.getElementById("subscribe-button-container");await at()?e.innerHTML=Je():e.innerHTML=Ye(),document.getElementById("subscribe-button-container").addEventListener("click",function(){dn()})};window.stream=null;document.addEventListener("DOMContentLoaded",async()=>{const n=new un({content:document.querySelector("#main-content"),drawerButton:document.querySelector("#drawer-button"),navigationDrawer:document.querySelector("#navigation-drawer")});await n.renderPage(),window.addEventListener("hashchange",async()=>{xt(),await n.renderPage()})});window.addEventListener("click",n=>{if(n.target.id==="close-message"&&n.target.closest("#message").remove(),n.target.id==="drawer-button"){const e=n.target.parentElement.querySelector("#navigation-drawer");e.classList.toggle("hidden"),e.classList.toggle("opacity-0")}});
